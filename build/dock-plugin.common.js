...
function install(editor, _ref) {
  ...
  var copy = new rete.NodeEditor(editor.id, editor.view.container); //const clickStrategy = new ClickStrategy(editor);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              component.editor = copy; // eslint-disable-next-line camelcase
